...
public class ApptRandomTest {
    ...
    */
    ...
    // This code is basically altered from Ali Aburasa's given test.
    // It however uses random integers in a specified range rather than
    // from 0 ot 9.  It also comments out the internal for loop and adds
    // a 10% chance for a null input string.  Also fixed the name of the
    // function from radnomtest to randomTest
    @Test
    public void randomTest()  throws Throwable  {
        ...
        try {
            ...
            for (int iteration = 0; elapsed < TestTimeout; iteration++) {
                ...
                // Give a 10% chance that someone enters null, else give
                if ((10 % (mod + 1)) < 2)
