...
public class CalDayTest {
	...
	public void testCreatedInvalidAppt()  throws Throwable  {
	    ...
	    Appt awesomeAppt = new Appt(-57, 97, 57, -1, 0,"Lol this would never work...", "We really don' goof trying to add this... :D");

	    sooperDay.addAppt(awesomeAppt);

	    // Check if the list actually behaves and size is 0
	    assertEquals(0, sooperDay.getSizeAppts());
    }
